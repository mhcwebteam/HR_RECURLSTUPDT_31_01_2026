...
//   //     cancelButtonColor: 'rgb(221, 211, 211)',
...
//             {/* Sticky Header - Ultra Compressed */}
...
//             {/* Scrollable Content */}
//             <div className="p-1.5 rounded-xl shadow-2xl border border-gray-300 bg-gradient-to-br from-pink-50 via-gray-50 to-gray-100">
...
//                   className="rounded-xl shadow-lg p-2 border border-gray-100 bg-gradient-to-br from-pink-50 to-pink-100"
//                 >
//                   <div className="flex items-center gap-1.5 mb-1.5">
//                     <div className="p-1 bg-gradient-to-r from-pink-500 to-pink-600 rounded-md">
...
//                   className="rounded-xl shadow-lg p-2 border border-gray-100 bg-gradient-to-br from-blue-50 to-blue-100"
//                 >
//                   <div className="flex items-center gap-1.5 mb-1.5">
//                     <div className="p-1 bg-gradient-to-r from-blue-500 to-blue-600 rounded-md">
//                       <BriefcaseIcon className="w-3.5 h-3.5 text-white" />
//                     </div>
//                     <h2 className="text-sm font-bold text-gray-800">Job Requisition Details</h2>
//                   </div>
...
//                   className="rounded-xl shadow-lg p-2 border border-gray-100 bg-gradient-to-br from-green-50 to-green-100"
//                 >
//                   <div className="flex items-center gap-1.5 mb-1.5">
//                     <div className="p-1 bg-gradient-to-r from-green-500 to-green-600 rounded-md">
//                       <AcademicCapIcon className="w-3.5 h-3.5 text-white" />
//                     </div>
//                     <h2 className="text-sm font-bold text-gray-800">Required Skills</h2>
//                   </div>
...
//                     className="rounded-xl shadow-lg p-2 border border-gray-100 bg-gradient-to-br from-purple-50 to-purple-100"
//                   >
//                     <div className="flex items-center gap-1.5 mb-1.5">
//                       <div className="p-1 bg-gradient-to-r from-purple-500 to-purple-600 rounded-md">
...
//                             <th className="px-2 py-1 text-left text-xs font-semibold">S.No</th>
//                             <th className="px-2 py-1 text-left text-xs font-semibold">Job Title</th>
//                             <th className="px-2 py-1 text-left text-xs font-semibold">Req By Date</th>
//                           </tr>
//                         </thead>
//                         <tbody>
//                           <tr className="border-t">
//                             <td className="px-2 py-1 text-xs text-gray-900 border-b border-r border-gray-300">
//                               {formData.SNO}
//                             </td>
//                             <td className="px-2 py-1 text-xs text-gray-900 border-b border-r border-gray-300">
//                               {formData.JOB_TIT}
...
//                         <div className="rounded-xl shadow-lg p-2 border border-gray-100 bg-gradient-to-br from-yellow-50 to-yellow-100">
//                           <div className="mb-1.5">
//                             <div className="flex items-center gap-1.5">
//                               <div className="p-1 bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-md">
//                                 <CalendarCheck className="w-3.5 h-3.5 text-white" />
//                               </div>
//                               <h2 className="text-sm font-bold text-gray-800">Approvals</h2>
//                             </div>
//                           </div>
